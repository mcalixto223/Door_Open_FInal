...
// Input Pins
  ...
  // Door Statement
    int door_state = 0;
    void door_state_0(void);
    void door_state_1(void);
    void door_state_2(void);
    void door_state_3(void);
